...
var multi_en = '<p class="text-muted description EN-text" >Throughout the years, Jahan Moura has become an expert at providing multimodal transportation solutions to our customers for their special needs. We evaluate the cargo to come up with the best, most secure,  and fastest way to handle the cargo. Whether it is a time-sensitive situation or the destination is in a remote area, we use all modes of freight transportation to meet your needs.</p>';
var jit_en = '<p class="text-muted description EN-text" >Jahan Moura has adopted just-in-time methodology to reduce the response time from freight companies and to transport the cargo in the fastest and most cost-effective manner.</p>';
